...
Status: **complete** (4/4 configurations completed).
...
| SwinV2 only ⚠ | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | **0.0000** |
...
⚠ SwinV2-only likewise made no positive predictions for any target pathology. Its positive-score maxima ranged from 0.0439 to 0.1207, also below every corresponding validation threshold. The saved full-split probabilities differ materially from all-three (maximum absolute delta 0.9090), confirming that the ablation was active; the zero-F1 result is reported unchanged.
